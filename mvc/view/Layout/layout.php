...
<body>
        ...
        <div class="header">
            ...
            <div class="my-navbar">
                ...
                <ul class="my-navbar-center">
                    <li class="drop">
                        <a href="http://localhost/Aglet/product_list?gender=all" class="drop-toggle">TẤT CẢ<i class="fa-solid fa-angle-down fa-xs"></i></a>
                        <div class="mega-menu">
    ...
    <?php require_once "./mvc/view/" . $data["page"] . "/" . $data["page"] . ".php" ?>
    <div id="footer">
