            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="http://localhost/aglet/logout">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
...
>>>>>>> e1fb78598715ce812d766cc254cfda05589ce84b
                        </div>
                        <div class="sb-sidenav-menu-heading">Statistical</div>
                        <a class="nav-link" href="charts.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
        ...
        <div id="layoutSidenav_content">
            <?php require_once "./mvc/view/admin/" . $data["page"] . "/" . $data["page"] . ".php" ?>
