    ...
    <ul class="pagination">
      <li class="page-item">
        <a href="<?php
                  $page = $data["pg"];
                  if ($page[0] == 1)
                    echo "http://localhost/aglet/admin/orderManagement/" . ($page[0]);
                  else
                    echo "http://localhost/aglet/admin/orderManagement/" . ($page[0] - 1);
      ...
      while ($i <= $pages) {
        echo "
                        <li class=", "page-item", "><a class=", "page-link", " href= ", "http://localhost/aglet/admin/orderManagement/" . $i . ">" . $i . "</a></li>
                    ";
        $i++;
      }
